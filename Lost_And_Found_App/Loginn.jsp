...
<head>
    ...
    <title>APSiT Found It Senior2Junior Login</title>
    ...
    <style>
        ...
        * {
        ...
        @media (max-width: 768px) {
            ...
            .login-section { padding-top: 2rem; margin-top: -90px; }
        }
...
<div class="navbar">
    ...
    <div class="nav-links">
        ...
        <a href="Loginn.jsp" class="active"><i class="fa-solid fa-right-to-bracket"></i>Login</a>
        <a href="register2.jsp"><i class="fa-solid fa-user-plus"></i>Register</a>
    </div>
</div>

<!-- HERO -->
<div class="hero">
    <h1>Senior2Junior Login</h1>
    <p>APSIT students & alumni marketplace</p>
</div>
...
<section class="login-section">
    <div class="login-card">
        ...
        <div class="switch-link">
            New here? <a href="register2.jsp">Create an account</a>
        </div>

        <form method="POST">
            <div class="form-group">
                <input type="email" name="un" placeholder="Email (must end with @apsit.edu.in)" 
                       required pattern=".*@apsit\.edu\.in" 
                       title="Only APSIT email addresses are allowed"
                       autocomplete="email">
            </div>
        ...
        if (request.getParameter("btn") != null) {
            String un = request.getParameter("un").trim().toLowerCase();
            String pw = request.getParameter("pw").trim();

            if (!un.endsWith("@apsit.edu.in")) {
                errorMsg = "Only @apsit.edu.in email addresses are allowed";
            } else {
                try {
                    ...
                    if (rs.next()) {
                        ...
                        if (un.equalsIgnoreCase("admin@apsit.edu.in")) {
