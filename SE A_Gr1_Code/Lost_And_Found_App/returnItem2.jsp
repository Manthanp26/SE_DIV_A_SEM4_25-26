...
<head>
    ...
    <title>Returned Items | APSiT Found It</title>
...
<div class="hero">
    ...
    <p>Items successfully returned to their owners</p>
</div>

<!-- RETURNED ITEMS -->
<section class="section">
    <h2>All Returned Items</h2>
    <div class="items">
    <%
    Connection con = null;
    ...
    try {
        ...
        con = DriverManager.getConnection("jdbc:mysql://localhost:3306/users_10jan26", "root", "abc123");
        ps = con.prepareStatement("SELECT * FROM items WHERE status = 'returned'");
        rs = ps.executeQuery();
    ...
    %>
        <div class="item-card-wrapper">
            <div class="item-card" style="--i: <%= index++ %>;">
                ...
                <a href="deleteItem.jsp?id=<%= rs.getInt("id") %>" class="delete-btn">Delete Record</a>
            </div>
        </div>
    <%
        }
    } catch (Exception e) {
        out.println("<p style='color:red; text-align:center;'>Error loading returned items: " + e.getMessage() + "</p>");
    } finally {
